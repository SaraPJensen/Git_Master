...
class Outer_Simplicial_2finder_advanced(nn.Module):    #This should return the number of 2-simplices of which each neuron is the source, sink and mediator
    DATASET = W0_to_simplex_Dataset
    NAME = "outer_simplicial_1dim_advanced"
